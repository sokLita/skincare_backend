...
<head>
    ...
    <title>Admin Register — June Shop</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-card {
            ...
            box-shadow: 0 20px 60px rgba(0, 0, 0, 0.06), 0 8px 24px rgba(168, 213, 186, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.6);
            padding: 40px 36px 32px;
        }
        .auth-logo { display: flex; justify-content: center; margin-bottom: 20px; }
        .logo-circle { position: relative; width: 72px; height: 72px; display: flex; align-items: center; justify-content: center; }
        .logo-circle svg:first-child { position: absolute; inset: 0; }
        .auth-title { font-family: 'Playfair Display', Georgia, serif; font-size: 26px; font-weight: 700; color: #3d3d3d; text-align: center; margin: 0 0 6px; }
        .auth-subtitle { font-size: 14px; color: #9a8a8a; text-align: center; margin: 0 0 28px; line-height: 1.5; }
        .auth-form { display: flex; flex-direction: column; gap: 14px; }
        .form-group { width: 100%; }
        .form-label { display: block; font-size: 13px; font-weight: 500; color: #6a5a5a; margin-bottom: 6px; }
        .input-wrapper {
            position: relative;
            display: flex;
            align-items: center;
        ...
        .input-icon { color: #b8a8a8; flex-shrink: 0; width: 18px; height: 18px; transition: color 0.25s ease; }
        .input-wrapper:focus-within .input-icon { color: #8ab894; }
        .form-input {
            flex: 1;
            padding: 14px 10px;
            border: none;
        ...
        .form-input:-webkit-autofill { -webkit-box-shadow: 0 0 0 30px rgba(255, 255, 255, 0.7) inset !important; -webkit-text-fill-color: #3d3d3d !important; }
        .error-alert {
        ...
        .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(102, 126, 234, 0.3); }
        .btn-submit:active { transform: translateY(0); }
        .auth-footer { text-align: center; margin-top: 24px; font-size: 13px; color: #9a8a8a; }
        .auth-footer a { color: #8ab894; text-decoration: none; font-weight: 600; transition: color 0.2s; }
        .auth-footer a:hover { color: #6a9a74; }
        .auth-divider { display: flex; align-items: center; gap: 12px; margin: 18px 0; color: #c0b0b0; font-size: 12px; }
        .auth-divider-line { flex: 1; height: 1px; background: rgba(200, 190, 180, 0.3); }
        .btn-back { display: inline-flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 500; color: #9a8a8a; text-decoration: none; margin-bottom: 16px; transition: color 0.2s; }
            ...
            <form method="POST" action="{{ route('admin.register.post') }}" class="auth-form">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <svg class="input-icon" viewBox="0 0 20 20" fill="none" width="18" height="18">
                            <circle cx="10" cy="7" r="4" stroke="currentColor" stroke-width="1.5" fill="none"/>
                            <path d="M3 19C3 14.6 6.1 11 10 11C13.9 11 17 14.6 17 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/>
                        </svg>
                        <input class="form-input" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Enter your full name" required autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="email">Email</label>
                    <div class="input-wrapper">
                        <svg class="input-icon" viewBox="0 0 20 16" fill="none" width="18" height="18">
                        ...
                        <input class="form-input" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="password">Password</label>
                    <div class="input-wrapper">
                        <svg class="input-icon" viewBox="0 0 18 20" fill="none" width="18" height="18">
                        ...
                        <input class="form-input" id="password" type="password" name="password" placeholder="Choose a password" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input class="form-input" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm your password" required>
                    </div>
                </div>
